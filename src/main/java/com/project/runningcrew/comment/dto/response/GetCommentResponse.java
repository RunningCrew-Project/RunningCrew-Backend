...
public class GetCommentResponse {
    ...
    @JsonProperty("board")
    private SimpleBoardOfCommentDto simpleBoardOfCommentDto;
    ...
    public GetCommentResponse(Comment comment) {
        ...
        if(comment instanceof BoardComment) {
            ...
            this.simpleBoardOfCommentDto = new SimpleBoardOfCommentDto(boardComment.getBoard());
            ...
            this.simpleBoardOfCommentDto = null;
        }
